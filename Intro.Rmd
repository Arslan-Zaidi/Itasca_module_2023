...
while( i < 5 ){       # execute the code block while counter is less than 5
  print(i)            # do something with it
  i=i+1               # advance the counter by adding 1; 
# if not included, this code block will enter an infinite loop so be very 
  #cautious when using a while loop!
}
...
**Q3.** Can you answer Q2 using `apply`, i.e., without a loop?
